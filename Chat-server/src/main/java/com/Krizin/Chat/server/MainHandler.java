...
public class MainHandler extends SimpleChannelInboundHandler<String> {
    ...
    public void channelActive(ChannelHandlerContext ctx) throws Exception {
        System.out.println("The client is connected" + ctx);
        channels.add(ctx.channel());
        clientName = "Client number" + newClientIndex;
        newClientIndex++;
        broadcastMessage("SERVER", "A new client is connected: " + clientName);
    }
    ...
    public void exceptionCaught(ChannelHandlerContext ctx, Throwable cause) throws Exception {
        System.out.println("Client " + clientName + " fell off");
        channels.remove(ctx.channel());
        broadcastMessage("SERVER", "Client " + clientName + "out");
        ctx.close();
    }
}
